view: everbooked_quartiles {
  derived_table: {
    sql: select * from everbooked_pillow_quartiles
      ;;
  }
  ...
  set: detail {
    fields: [airbnb_listing_id, pricing_quartile_for_zip, occupancy_quartile_for_zip, days_on_market_quartile_for_zip, revpar_quartile_for_zip, pricing_quartile_for_city, occupancy_quartile_for_city, days_on_market_quartile_for_city, revpar_quartile_for_city, pricing_quartile_for_market, occupancy_quartile_for_market, days_on_market_quartile_for_market, revpar_quartile_for_market]
  }
}
